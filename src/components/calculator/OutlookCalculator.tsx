...
interface OutlookCalculatorProps {
  mode: 'comparison';
}
...
export default function OutlookCalculator({ }: OutlookCalculatorProps) {
  ...
  const onSubmit = (data: SimpleComparisonSchema) => {
    ...
    const domainsNeeded = Math.ceil(data.dailyEmails / 500);
    const ourCost = domainsNeeded * 50;
  ...
  return (
    <>
      ...
      <div className="relative h-[600px] lg:h-[500px] w-full lg:w-[700px]">
        ...
        <Image src="/orangeTint.svg" alt="Background" width={100} height={100} className="w-[400px] h-[200px] lg:w-[600px] lg:h-[320px] absolute bottom-0 z-[100] blur-2xl" />
      </div>
    </>
  );
}
